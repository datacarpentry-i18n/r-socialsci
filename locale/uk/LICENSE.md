...
- **Зазначення Авторства**---Ви маєте вказати автора (зазначивши, що ваша робота є похідною від роботи, яка захищена авторським правом Copyright © Software
  Carpentry та, де це можливо, зробити посилання на http\://software-carpentry.org/), надати [посилання на ліцензію][cc-by-human] та вказати, чи було внесено зміни. Ви можете зробити це будь-яким розумним чином, але не таким чином, щоб припустити, що ліцензіар підтримує чи схвалює вас або ваше використання матеріалу.
