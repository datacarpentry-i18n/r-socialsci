...
У цій трансформації є кілька нових концепцій, тому розглянемо її крок за кроком. Спершу ми створимо новий об’єкт (`interviews_items_owned`) на основі дата фрейму `interviews`.

```{r, eval=FALSE}
interviews_items_owned <- interviews %>%
```

Тоді нам насправді потрібно зробити наш дата фрейм довшим, тому що в одній клітинці міститься кілька предметів.
