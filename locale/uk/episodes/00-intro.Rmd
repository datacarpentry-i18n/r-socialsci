...
[RStudio](https://rstudio.com) нині є дуже популярним способом не тільки писати ваші скрипти на R, але й взаємодіяти з програмним забезпеченням R. Для правильної роботи RStudio потребує R і тому обидва необхідно встановити на ваш комп'ютер.
...
- У меню `Файл` натисніть `Новий проєкт`, виберіть `Новий каталог`, потім
  `Новий проєкт`
...
- Створіть новий файл, у якому ми будемо писати наші скрипти. Перейдіть до Файл > Новий файл > Скрипт R. Натисніть значок збереження на панелі інструментів і збережіть ваш скрипт як  "`script.R`".
...
та їх вміст можна налаштувати (див. Меню, Інструменти -> Глобальні параметри -> Макет панелі).

Макет за замовчуванням:

- Ліворуч вгорі - **Джерело**: ваші скрипти та документи
- Ліворуч унизу - **Консоль**: як виглядав би R без RStudio
- Праворуч угорі - **Середовище/Історія**: тут можна побачити, що ви зробили
- Праворуч унизу - **Файли** а інші вкладки: тут можна переглядати вміст проєкту/робочого каталогу, наприклад ваш файл Script.R
...
- **`data/`** Використовуйте цю теку для зберігання необроблених даних та проміжних наборів даних.
  З метою прозорості та [provenience] (https://en.wikipedia.org/wiki/Provenance), ви  повинні _завжди_ зберігати копію ваших необроблених даних доступною та максимально виконувати очищення й попередню обробку даних програмно (тобто за допомогою скриптів, а не вручну), наскільки це можливо.
