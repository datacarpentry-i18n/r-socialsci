...
- Повільно перейдіть у розділ «Налаштування». Переконайтеся, що всі стежать за вами (нагадайте  учням використовувати наліпки). На цьому етапі сплануйте з помічниками ходити по кімнаті й будьте готові допомогти. It's important to make
...
- Встановити додаткові пакети за допомогою R коду.
